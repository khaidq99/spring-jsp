...
<body>
<form id="payment_form" action="payment-confirmation" method="post">
    <input type="hidden" name="access_key" value="e6052dd3148e3519a5e4364e18612a2a">
    <input type="hidden" name="profile_id" value="B5A14A3B-132A-4919-9011-A0CE48053A43">
